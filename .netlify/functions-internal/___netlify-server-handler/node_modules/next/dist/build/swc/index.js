...
const nextVersion = "15.4.2-canary.42";
                ...
                for (const key of ruleKeys){
                    nextConfig.turbopack.rules[key] = {
                        browser: {
                            foreign: false,
                            loaders: [
                                (0, _getbabelloaderconfig.getReactCompilerLoader)(originalNextConfig.experimental.reactCompiler, projectPath, nextConfig.dev, /* isServer */ false, /* reactCompilerExclude */ undefined)
                            ]
                        }
                    };
                }
